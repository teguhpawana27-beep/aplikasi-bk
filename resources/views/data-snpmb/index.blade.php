    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-2 text-lg text-slate-500">
                Kelola data pendaftaran SNPMB siswa SMKN 1 Majalaya.
            </p>
        </div>

        <a
            href="{{ route('data-snpmb.create') }}"
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <div class="border-b border-slate-200 px-8 py-6">
            ...
            <h2 class="text-2xl font-semibold text-slate-900">
                Daftar Data Siswa SNPMB
            </h2>

            <p class="mt-1 text-sm text-slate-500">
                Data pendaftaran dan hasil SNPMB siswa.
            </p>
            ...
            <table class="min-w-full">
                ...
                <thead class="bg-slate-50">
                    ...
                    <tr class="border-b border-slate-200">
                        ...
                        <th class="whitespace-nowrap px-8 py-5 text-left text-xs font-bold uppercase tracking-wide text-slate-500">
                            No
                        </th>

                        <th class="whitespace-nowrap px-6 py-5 text-left text-xs font-bold uppercase tracking-wide text-slate-500">
                            Nama Siswa
                        </th>
                        ...
                        <th class="whitespace-nowrap px-8 py-5 text-center text-xs font-bold uppercase tracking-wide text-slate-500">
                            Aksi
                        </th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @forelse ($dataSNPMB as $index => $item)
                        ...
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-6 py-6 align-middle">
                                ...
                                <span class="block min-w-[160px] text-sm text-slate-600">
                                    {{ $item->program_studi ?: '-' }}
                                </span>
                            ...
                            <td class="px-6 py-6 align-middle">
                                ...
                                @if ($item->status_pendaftaran)

                                    <span class="inline-flex whitespace-nowrap rounded-full bg-blue-100 px-3 py-1.5 text-xs font-semibold text-blue-700">
                            ...
                            <td class="px-8 py-6 text-center align-middle">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {{-- LIHAT --}}
                                        <a
                                            href="{{ route('data-snpmb.show', $item->id) }}"
                                        ...
                                        {{-- EDIT --}}
                                        <a
                                            href="{{ route('data-snpmb.edit', $item->id) }}"
                                        ...
                                        {{-- CETAK PDF --}}
                                        <a
                                            href="{{ route('data-snpmb.pdf', $item->id) }}"
                                            target="_blank"
                                        ...
                                        {{-- HAPUS --}}
                                        <form
                                            action="{{ route('data-snpmb.destroy', $item->id) }}"
                                            method="POST"
                                            onsubmit="return confirm('Yakin ingin menghapus data SNPMB ini?')"
                                        >
                            ...
                            >
                                ...
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-base font-semibold text-slate-700">
                                        Belum ada data SNPMB
                                    </p>

                                    <p class="mt-1 text-sm text-slate-400">
                                        Silakan tambahkan data SNPMB terlebih dahulu.
                                    </p>
