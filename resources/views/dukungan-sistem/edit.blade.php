...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">
                Edit Dukungan Sistem
            </h1>

            <p class="text-sm text-slate-500 mt-1">
                Perbarui data kegiatan dukungan sistem Bimbingan dan Konseling
            </p>
        </div>
    ...
    <form
        action="{{ route('dukungan-sistem.update', $dukunganSistem->id) }}"
        method="POST"
        class="space-y-6"
    >
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($guruBK as $item)
                            ...
                            <option
                                value="{{ $item->id }}"
                                {{ old('guru_bk_id', $dukunganSistem->guru_bk_id) == $item->id ? 'selected' : '' }}
                            >
                                {{ $item->nama_lengkap }}
                            </option>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($tahunAjaran as $item)
                            ...
                            <option
                                value="{{ $item->id }}"
                                {{ old('tahun_ajaran_id', $dukunganSistem->tahun_ajaran_id) == $item->id ? 'selected' : '' }}
                            >
                                {{ $item->nama }}
                            </option>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($jenisKegiatan as $jenis)
                            ...
                            <option
                                value="{{ $jenis }}"
                                {{ old('jenis_kegiatan', $dukunganSistem->jenis_kegiatan) == $jenis ? 'selected' : '' }}
                            >
                                {{ $jenis }}
                            </option>
                    ...
                    <input
                        ...
                        value="{{ old(
                            ...
                            $dukunganSistem->tanggal
                                ? $dukunganSistem->tanggal->format('Y-m-d')
                                : ''
                        ) }}"
                        required
                        class="w-full rounded-xl border-slate-300
        ...
        <div class="rounded-2xl border border-slate-200
            ...
            <p class="text-sm text-slate-500 mb-5">
                Filter siswa berdasarkan Tahun Ajaran, Tingkat,
                Jurusan, dan Kelas.
            </p>
            ...
            <div class="mt-4 rounded-xl bg-blue-50
                ...
                <p class="text-sm text-blue-700">
                    ...
                    Siswa ditampilkan sesuai dengan kelas yang dipilih.
                    Jika kegiatan tidak berkaitan dengan siswa tertentu,
                    siswa dapat dikosongkan.
        ...
        <div class="rounded-2xl border border-slate-200
            ...
            <div class="mb-5">
                ...
                <input
                    type="text"
                    name="sasaran"
                    value="{{ old('sasaran', $dukunganSistem->sasaran) }}"
                    required
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full rounded-xl border-slate-300
                           focus:border-blue-500 focus:ring-blue-500"
                >{{ old('uraian_kegiatan', $dukunganSistem->uraian_kegiatan) }}</textarea>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border-slate-300
                               focus:border-blue-500 focus:ring-blue-500"
                    >{{ old('hasil', $dukunganSistem->hasil) }}</textarea>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border-slate-300
                               focus:border-blue-500 focus:ring-blue-500"
                    >{{ old('evaluasi', $dukunganSistem->evaluasi) }}</textarea>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border-slate-300
                               focus:border-blue-500 focus:ring-blue-500"
                    >{{ old('tindak_lanjut', $dukunganSistem->tindak_lanjut) }}</textarea>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border-slate-300
                               focus:border-blue-500 focus:ring-blue-500"
                    >{{ old('keterangan', $dukunganSistem->keterangan) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const jurusan =
        document.getElementById('jurusan_id');
